    ...
    <>
      ...
      <div className="board-body mt-2">
        <ul className="list-group">
          ...
          <li className="list-group-item list-group-item-dark d-flex justify-content-between dropdown-toggle" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><strong className="text-center">Produtos</strong></li>
