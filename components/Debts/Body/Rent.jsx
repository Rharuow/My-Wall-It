    ...
    <>
      ...
      <div className="board-body mt-2">
        <ul className="list-group">
          <li className="list-group-item list-group-item-dark d-flex justify-content-between">Residência: <strong className="text-center">{info.name}</strong></li>
          ...
          <li className="list-group-item list-group-item-dark d-flex justify-content-between">Data de início: <strong className="text-center">{info.createdAt}</strong></li>
          ...
          <li className="list-group-item list-group-item-dark d-flex justify-content-between">Vencimento: <strong className="text-center">{info.dueDate}</strong></li>
